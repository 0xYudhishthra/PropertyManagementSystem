 ...
 * @author User
 */
public class VisitorPassCode extends javax.swing.JFrame {

    /**
     * Creates new form VisitorPassCode
     */
    public VisitorPassCode() {
        initComponents();
    ...
    private void SubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButtonActionPerformed
        ...
        String[] verifyStat = new VisitorFileHandler().verify(code);
        if(verifyStat[0] != "TT"){
            Visitor.VisitorDetails vd = new Visitor.VisitorDetails(verifyStat);
            vd.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisitorPassCode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisitorPassCode().setVisible(true);
            }
        });
    }
