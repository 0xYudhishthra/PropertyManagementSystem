...
public class Fund extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fund Allocations");
        ...
        jLabel7.setText("Total Fund :");

        jLabel8.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        jLabel8.setText("Add Fund Allocation");
        ...
        jLabel9.setText("Fund ID");

        jTextField3.setText("Fund ID");
    ...
    private void updateTableList() {
        ...
        try {
            data = fileHandler.readData("funds", "BuildingManager");
        } catch (Exception e) {
        ...
        for( int i = 0; i < userArray.size(); i++ ) {
            totalFund += Integer.parseInt(userArray.get(i).get(2));
        }

        jLabel5.setText(""+totalFund);
    }
    ...
    private void createData() {
        ...
        data.put("FUND ID", jTextField3.getText());
        data.put("FUND NAME", jTextField2.getText());
        data.put("FUND AMOUNT", jTextField4.getText());

        //turn fundamount into int if invalid, return with error message
        try {
            Integer.parseInt(jTextField4.getText());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Invalid fund amount");
            return;
        }

        try {
            fileHandler.createData("funds", data, "BuildingManager");
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
