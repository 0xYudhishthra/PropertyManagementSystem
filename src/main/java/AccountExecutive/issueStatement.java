...
public class issueStatement extends javax.swing.JFrame {
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        ...
        if (statementOutputTable.getRowCount() == 0) {
        ...
        for (int i = 0; i < statementOutputTable.getRowCount(); i++) {
            ...
            if (statementOutputTable.getValueAt(i, 0) != null) {
                for (int j = 0; j < statementOutputTable.getColumnCount(); j++) {
                    lineData.put(statementOutputTable.getColumnName(j), statementOutputTable.getValueAt(i, j).toString());
                }
